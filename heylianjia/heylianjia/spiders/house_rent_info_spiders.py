...
class HouseSaleInfoSpider(scrapy.Spider):
    ...
    condition = "rba30rea100brp4000erp5999"
    start_urls = [
        #"http://bj.lianjia.com/zufang/dongcheng/%s/" % (condition),
        #"http://bj.lianjia.com/zufang/xicheng/%s/"% (condition),
        #"http://bj.lianjia.com/zufang/chaoyang/%s/"% (condition),
        #"http://bj.lianjia.com/zufang/haidian/%s/"% (condition),
        #"http://bj.lianjia.com/zufang/fengtai/%s/"% (condition),
        #"http://bj.lianjia.com/zufang/shijingshan/%s/"% (condition),
        #"http://bj.lianjia.com/zufang/tongzhou/%s/"% (condition),
        #"http://bj.lianjia.com/zufang/changping/%s/"% (condition),
        #"http://bj.lianjia.com/zufang/daxing/%s/"% (condition),
        #"http://bj.lianjia.com/zufang/yizhuangkaifaqu/%s/"% (condition),
        #"http://bj.lianjia.com/zufang/shunyi/%s/"% (condition),
        #"http://bj.lianjia.com/zufang/fangshan/%s/"% (condition),
        #"http://bj.lianjia.com/zufang/mentougou/%s/"% (condition),
        #"http://bj.lianjia.com/zufang/pinggu/%s/"% (condition),
        #"http://bj.lianjia.com/zufang/huairou/%s/"% (condition),
        #"http://bj.lianjia.com/zufang/miyun/%s/"% (condition),
        #"http://bj.lianjia.com/zufang/yanqing/%s/"% (condition),
        "http://bj.lianjia.com/zufang/yanjiao/%s/"% (condition),
    ]
    ...
    def parse(self,response):
        ...
        for div in house_info_divs :
            ...
            item['rent'] = float(div.xpath('.//div[@class="price"]//span//text()').extract()[0])
